...
- [ ] Why we have so many events from Wind observations?
  - Biased by different methods.
- [x] Show PSP and ARTEMIS examples with Bn/B~0.75?
  - [ ] Check $B_n$ dependence to check method bias (duration / thickness)
...
- [ ] Check the occurrence rates correlation with fluctuation level / residual energy at similar radial distance.
