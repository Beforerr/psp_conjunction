...
```{julia}
function plot_candidate(f, event, config, toffset=Second(0); kwargs...)
    ...
    result = [tnorm_combine(B_mva), tsubtract(V_mva), n, tsubtract(Va), J]
...
res_psp = plot_candidate(f[1, 1], psp_df[18, :], psp_config, Second(10))
...
using Discontinuity: compute_params!, filter_low_mva_quality, compute_Alfvenicity_params!
using Beforerr
