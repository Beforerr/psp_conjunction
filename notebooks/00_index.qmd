...
psp_temp = SPEDAS.DataSet(
    ...
    [
        ...
        SpeasyProduct("PSP_FLD_L3_SQTN_RFS_V1V2/electron_core_temperature"; labels=["SQTN Electron core"]),
    ];
    ylabel=Temp_ylabel
)

tvars_psp = [
    tnorm_combine ∘ SpeasyProduct("PSP_FLD_L2_MAG_RTN_4_SA_PER_CYC/psp_fld_l2_mag_RTN_4_Sa_per_Cyc"; ylabel=B_ylabel, labels=B_labels),
    psp_n,
