...
```{julia}
tvars_wind = [
    set(tnorm_combine ∘ Wind.B_GSE; ylabel=B_ylabel),
    set(Wind.n; ylabel=n_ylabel),
    # set(Wind.V_GSE_p; ylabel=V_ylabel),
    replace_outliers! ∘ set(Wind.V_GSE_K0; ylabel=V_ylabel),
...
thx_v_gse = THEMIS.V_GSE(tmin_wind, tmax_wind)
...
tvars_themis = [
    ...
    THEMIS.n,
    _tmask! ∘ THEMIS.V_GSE,
    set(_tmask! ∘ THEMIS.eTemp; ylabel=T_ylabel)
]
...
tplot(f[1, 3], tvars_themis, tmin_wind, tmax_wind; legend)
