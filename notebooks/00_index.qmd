...
tmax_wind = DateTime("2021-01-19")

density_tvar = SPEDAS.DataSet(
    "Density",
    [
...
wind_B = tnorm_combine ∘ SpeasyProduct(
    "cda/WI_H2_MFI/BGSE",
    (; ylabel="B (nT)", labels=["Bx", "By", "Bz", "Magnitude"])
)

wind_vel = tnorm_combine ∘ SpeasyProduct(
    "cda/WI_K0_SWE_RTN/V_RTN"
...
add_labels!(; position=Left(), valign=:top, halign=:left, padding=(10, 10, 10, 0));
f
```